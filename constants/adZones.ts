/**
 * Shared ad zone definitions.
 * Imported by both the Convex backend (convex/ads.ts) and the React Native app.
 * Keep this file free of any server-only or Node.js-only imports.
 */
